...
def create_pipe():
    ...
    bottom_pipe = pipe_surface.get_rect(midtop =(1250,random_pipe_post))
...
bg = pygame.image.load(r"assets\background-1.jpg")

fl = pygame.image.load(r"assets\floor6.png")
fl = pygame.transform.scale2x(fl)
fl_x = 0 

bird_move = 0 
bird_down = pygame.image.load(r"assets\birddown.png")
bird_mid = pygame.image.load(r"assets\birddown.png")
bird_up = pygame.image.load(r"assets\birdup.png")
...
pipe_surface = pygame.transform.scale2x(pygame.image.load(r"assets\pipe1.png"))
pipe_list = []
...
game_welcome = pygame.image.load(r"assets\welcome.png")
game_over_surface = pygame.image.load(r"assets\end.png")
game_over_surface1 = pygame.transform.scale2x(pygame.image.load(r"assets\pressspace.png"))
dis_level = pygame.image.load(r'assets\level.png')
dis_level_de = pygame.image.load(r'assets\level-de_transparent.png')
dis_level_thuong = pygame.image.load(r'assets\level-thuong_transparent.png')
dis_level_kho = pygame.image.load(r'assets\level-kho_transparent.png')
dis_level_sieukho = pygame.image.load(r'assets\level-sieukho_transparent.png')
